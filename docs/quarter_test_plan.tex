...
\begin{itemize}
  \item Configuration Manipulation Testing
  \begin{itemize}
    \item Printing correct prompts and information
    \item user inputs are processed correctly
    
  \item \texttt{API} Communication
    \item supports functionality of the API
    \item recives and gives information to the API correctly
